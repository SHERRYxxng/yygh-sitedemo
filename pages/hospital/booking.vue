...
export default {
  ...
  created() {
    //http://localhost:3000/hospital/booking?scheduleId=64a3ce969f556b027c490d7a
    //点击的排班id
  ...
  methods: {
    ...
    submitOrder() {
        ...
        orderinfoApi.submitOrder(this.patient.id,this.scheduleId).then(resp=>{
