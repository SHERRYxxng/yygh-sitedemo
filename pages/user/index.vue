            ...
            <el-form :model="userAuah" label-width="110px" label-position="left">
              <el-form-item prop="name" label="姓名：" class="form-normal">
                <div class="name-input">
                  <el-input v-model="userAuah.name" placeholder="请输姓名全称" class="input v-input"/>
                </div>
              </el-form-item>
          ...
          <div>
            <el-form :model="userInfo" label-width="110px" label-position="right">
              ...
              <el-form-item prop="name" label="证件图片：">
                <!-- <img width="30px" height="30px"  :src="userInfo.certificatesUrl" class="avatar"> -->
                    <div class="upload-inner-wrapper">
                        <img  :src="userInfo.certificatesUrl" class="avatar">
                      </div>
              </el-form-item>
            </el-form>
          </div>
...
export default {
  data() {
    return {
      ...
      fileUrl:'http://192.168.188.129:9001/api/oss/upload',
      userInfo: {
        param: {}
      },
      submitBnt: '提交'
